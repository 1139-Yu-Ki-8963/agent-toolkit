...
The final HTML is **offline and self-contained**, and `generating-explainer-html-validate_html.py` flags any
...
See `generating-explainer-yaml-sample-core.yaml` for a fuller, working example.
