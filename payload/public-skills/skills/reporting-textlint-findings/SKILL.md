...
| 区分 | 規則 | 値 |
|---|---|---|
| AI が使いがちな語（ai-words-ja） | 効く・道具・踏み込む・照合・実測など約 60 語と、短い主題直後の読点 | 既定 |
...
| `textlint-rule-preset-ai-words-ja` | ルール群 | AI が使いがちな語（約 60 語）を形態素解析で指摘する |
...
| ルール ID | 何を見るか |
|---|---|
| no-ai-words | AI が使いがちな語（土台・効く・実測など約 60 語） |
