...
テンプレート（`shared/templates/detail-pages/` 配下）を更新した場合、既に生成済みの HTML ファイルは旧テンプレートのままになる。以下のコマンドで再生成する。

```bash
bash shared/scripts/detail-pages/build-detail-page.sh <page-data.json> <output-dir> --page <kind>
```
