...
EOF
  ...
  : > "$tmp/docs/design/apis/api-get-users/テスト設計/API結合テスト設計書.md"
  ...
  : > "$tmp/docs/design/tables/table-users/テスト設計/テーブル結合テスト設計書.md"
  ...
  : > "$tmp/docs/design/batches/batch-cleanup/テスト設計/バッチ結合テスト設計書.md"
  ...
  : > "$tmp/docs/design/reports/report-sales/テスト設計/帳票結合テスト設計書.md"
  ...
  : > "$tmp/docs/design/externals/external-payment/テスト設計/外部連携結合テスト設計書.md"
  : > "$tmp/docs/design/externals/external-payment/テスト設計/外部連携単体テスト設計書.md"
  : > "$tmp/docs/design/externals/external-payment/要確認事項台帳.json"
  : > "$tmp/docs/design/features/feature-user-management/テスト設計/機能結合テスト設計書.md"
