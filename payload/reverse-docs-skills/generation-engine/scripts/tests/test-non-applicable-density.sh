...
TEMPLATE="$ROOT_DIR/delivery-payload/templates/リバース検証/画面/詳細設計/画面詳細設計書.md"
...
LAYOUT_JSON="$(resolve_output_layout "$ROOT_DIR/generation-engine/samples")" || exit 1
SCREEN_UNIT_ROOT_REL="$(output_layout_get "$LAYOUT_JSON" screenUnitRoot)" || exit 1
SAMPLES=(
  "$ROOT_DIR/generation-engine/samples/$SCREEN_UNIT_ROOT_REL/screen-home/詳細設計/画面詳細設計書.md"
  "$ROOT_DIR/generation-engine/samples/$SCREEN_UNIT_ROOT_REL/screen-member-edit/詳細設計/画面詳細設計書.md"
  "$ROOT_DIR/generation-engine/samples/$SCREEN_UNIT_ROOT_REL/screen-order-detail/詳細設計/画面詳細設計書.md"
  "$ROOT_DIR/generation-engine/samples/$SCREEN_UNIT_ROOT_REL/screen-order-list/詳細設計/画面詳細設計書.md"
  "$ROOT_DIR/generation-engine/samples/$SCREEN_UNIT_ROOT_REL/screen-sales-dashboard/詳細設計/画面詳細設計書.md"
)
...
AUDIT_SCRIPT="$ROOT_DIR/generation-engine/scripts/audit-consistency.sh"
