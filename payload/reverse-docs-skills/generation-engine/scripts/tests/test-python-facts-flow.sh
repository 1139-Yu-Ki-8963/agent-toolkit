...
ORCHESTRATOR_CONTRACT="$REPO_ROOT/.claude/skills/orchestrating-ai-development-setup/references/contract.md"
ORCHESTRATOR_GUIDE="$REPO_ROOT/.claude/skills/orchestrating-ai-development-setup/references/guide.html"
