#!/usr/bin/env bash
# check-verdict-hash-ancestry.sh — docs/scripts/check-verdict-hash-ancestry.sh の
...
# 2箇所だけである。本体(docs/scripts/check-verdict-hash-ancestry.sh)は
...
#
# 使い方: bash check-verdict-hash-ancestry.sh --self-test
set -euo pipefail
