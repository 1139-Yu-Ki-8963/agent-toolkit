...
with tempfile.TemporaryDirectory(prefix="maintaining-semantic-glossary-forward-") as temporary:
    ...
    paths = assert_fixture_set(
        ...
        repo_root,
        {
            "generation-engine/scripts/glossary/fixtures/valid-update-proposal.yaml",
    ...
    assert_observed(
        ...
        run_validator(
            validator,
            paths["generation-engine/scripts/glossary/fixtures/valid-update-proposal.yaml"],
    ...
    assert request["proposalRef"] == "generation-engine/scripts/glossary/fixtures/valid-update-proposal.yaml"
    assert request["registryRef"] == "generation-engine/scripts/glossary/fixtures/valid-glossary.yaml"
