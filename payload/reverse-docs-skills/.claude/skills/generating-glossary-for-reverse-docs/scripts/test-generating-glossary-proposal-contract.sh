...
source_proposal="$repo_root/generation-engine/scripts/glossary/fixtures/valid-proposal.yaml"
source_diagnostics="$skill_dir/fixtures/detected-proposal-diagnostics.json"
registry="$repo_root/generation-engine/scripts/glossary/fixtures/valid-glossary.yaml"
orchestrator="$repo_root/.claude/skills/orchestrating-ai-development-setup/SKILL.md"
contract="$repo_root/.claude/skills/orchestrating-ai-development-setup/references/contract.md"
readme="$repo_root/README.md"
delivery_layout="$repo_root/delivery-payload/references/納品物フォルダ体系.md"
