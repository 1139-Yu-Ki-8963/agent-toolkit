...
- portal投影: `../../../shared/scripts/detail-pages/project-semantic-glossary.py`
...
3. `project-semantic-glossary.py`をinput、registry、outputの各引数付きで実行する。
   ...
   page-dataの英語キーは保持し、閲覧用HTMLでは対応する日本語14列見出しを表示する。HTMLの正本配置は`<output_dir>/一覧/用語辞書/用語辞書.html`とし、`<output_dir>/用語辞書.html`へは生成しない。
...
- 共通契約: `../../../shared/references/semantic-glossary-contract-v0.1.md`
- 管理仕様: `../../../docs/design/用語管理Skill仕様書.md`
- 運用ルール: `../../../docs/design/用語運用ルール.md`
- 固有テスト観点: `references/test-cases.md`
- 人向けガイド: `references/managing-semantic-glossary-guide.html`
