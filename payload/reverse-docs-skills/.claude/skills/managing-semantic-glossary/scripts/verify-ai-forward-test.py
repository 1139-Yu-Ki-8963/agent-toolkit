...
canonical_registry = repo_root / "shared/scripts/glossary/fixtures/canonical-registry"
...
with tempfile.TemporaryDirectory(prefix="managing-semantic-glossary-forward-") as temporary:
    ...
    paths = assert_fixture_set(
        ...
        repo_root,
        {
            "shared/scripts/glossary/fixtures/valid-proposal.yaml",
    ...
    actual = run_validator(
        validator,
        paths["shared/scripts/glossary/fixtures/valid-proposal.yaml"],
    ...
    paths = assert_fixture_set(
        ...
        {
            "shared/scripts/glossary/fixtures/valid-glossary.yaml",
            "shared/scripts/glossary/fixtures/canonical-registry/customer-update-proposal.yaml",
            "shared/scripts/glossary/fixtures/canonical-registry/customer-update-change.yaml",
            "shared/scripts/glossary/fixtures/canonical-registry/customer-id-proposal.yaml",
            "shared/scripts/glossary/fixtures/canonical-registry/customer-id-change.yaml",
        },
    )
    source = paths["shared/scripts/glossary/fixtures/valid-glossary.yaml"]
