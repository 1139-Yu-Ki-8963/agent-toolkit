...
guide="$skill_dir/references/managing-semantic-glossary-guide.html"
...
negative_dir="$(mktemp -d "${TMPDIR:-/tmp}/managing-forward-negative.XXXXXX")"
...
printf 'PASS: managing-semantic-glossary rejects tampered recorded CLI observations\n'

printf 'PASS: managing-semantic-glossary deterministic CLI and static contract test\n'
