...
| 項目 | 値 |
|---|---|
| 出力フォルダ | `<output_dir>/バッチ/batch-<バッチ識別子>/基本設計/` |
| 出力ファイル | `バッチ基本設計書.md` |
| テンプレート | `<template_root>/リバース検証/バッチ/バッチ基本設計書.md` |
...
| status | 意味 |
|---|---|
| `DONE` | 全対象ユニットのバッチ基本設計書が業務語彙のみで記入済み、かつ Phase 4 の 4 検査すべてに合格した |
...
| **Goal** | 対象バッチごとに、業務語彙のみで書かれた基本設計書と要確認事項一覧が生成されている |
