...
| 種別 | 配置 |
| --- | --- |
| schema | `generation-engine/schemas/semantic-glossary/1.0.0/glossary.schema.yaml` |
| proposal schema | `generation-engine/schemas/semantic-glossary/1.0.0/proposal.schema.yaml` |
| change schema | `generation-engine/schemas/semantic-glossary/1.0.0/change.schema.yaml` |
| validation report schema | `generation-engine/schemas/semantic-glossary/1.0.0/validation-report.schema.yaml` |
| validator | `generation-engine/scripts/glossary/validate-semantic-glossary.sh` および `.py` |
| requirements | `generation-engine/scripts/glossary/requirements.txt` |
| fixtures/tests | `generation-engine/scripts/glossary/fixtures/`、`generation-engine/scripts/glossary/tests/` |
...
| portal基準テンプレート | `delivery-payload/templates/detail-pages/detail-t2-dictionary.html` |
| portal projection CLI | `generation-engine/scripts/detail-pages/project-semantic-glossary.py` |
| サンプル | `generation-engine/samples/一覧/用語辞書/用語辞書.html` |
...
- YAML構造と意味制約は、`generation-engine/schemas/semantic-glossary/1.0.0/`の正式schemaを基準にする。

## 4. CLI

```text
generation-engine/scripts/glossary/validate-semantic-glossary.sh \\
...
- projection CLIは次の形式とする。
  ...
  ```text
  python3 generation-engine/scripts/detail-pages/project-semantic-glossary.py \
    --input <glossary.yaml> \
    --registry <canonical-registry> \
