...
acceptance: tests/
---
<!-- 生成物: docs/skills/setup-checking-acceptance/SKILL.md から自動生成。直接編集しないこと -->
...
2. 出力の表（機能・単位・要件の 3 段）と欠落の一覧を読む。終了コード 0 だけを合格とする。欠落は 6 種類（tests無し機能・孤立tests・2単位に属する機能・統括直書きの機能名・他単位の名前を持つ機能・portal以外のhtml出力）
