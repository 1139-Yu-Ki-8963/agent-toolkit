...
# test-self-tests.sh — check-common-detail-design.sh --self-test を実行し、合否を報告する。
...
run_one "check-common-detail-design.sh" "${SCRIPTS_DIR}/check-common-detail-design.sh"
