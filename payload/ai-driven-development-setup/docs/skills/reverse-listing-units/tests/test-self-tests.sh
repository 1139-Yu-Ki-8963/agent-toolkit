...
# test-self-tests.sh — list-units.sh・check-requirement-mapping.sh・check-business-names.sh の --self-test を実行し、合否を報告する。
...
run_one "check-business-names.sh" "${SCRIPTS_DIR}/check-business-names.sh"
